...
public class Array extends ArrayAdapter<WarningLights> {
        private Context ctx;
        private int ResourceId;
        private ArrayList<WarningLights> ary;

        public Array(@NonNull Context context, int resource, @NonNull ArrayList<WarningLights> objects) {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            try{
                InputStream in= as.open("pics/"+c.getL());
                ;
