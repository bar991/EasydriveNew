...
public class Dal extends SQLiteAssetHelper {
    public Dal(Context context) {
        ...
        super(context, "3dbmdata.db", null, 1);
    }
    ...
    public ArrayList<WarningLights> getAllalert() {
        ...
        String st = "select * from warning_alert where type=\"Warning alert\" ";
        SQLiteDatabase db = getWritableDatabase();
    ...
    public boolean Checkdetail2sempty() {

        String st = "select * from warning_alert where type=\"Safety alert\" ";
    ...
    public boolean Checkdetail1sempty() {
    ...
    public boolean Checkdetail3sempty() {

        String st = "select * from warning_alert where type=\"Lighting symbols\" ";
    ...
    public boolean Checkgarageempty() {

        String st = "select * from garage";
...
return cursor.moveToNext();
    ...
    public ArrayList<WarningLights> getAlllightning() {
        ArrayList<WarningLights> ary1 = new ArrayList<>();
    ...
    public ArrayList<WarningLights> getAlllsafety() {
        ArrayList<WarningLights> ary1 = new ArrayList<>();
    ...
    public void addgarage(String img, String name, String type ) {

        SQLiteDatabase db1 = getWritableDatabase();
        String sql_INSERT2 = "INSERT INTO garage (img,name ,type) values(?,?,?)";
        SQLiteStatement statment1 = db1.compileStatement(sql_INSERT2);
    ...
    public ArrayList<WarningLights> getAllgarage() {
        ArrayList<WarningLights> ary1 = new ArrayList<>();

        String st1 = "select * from garage";
        SQLiteDatabase db = getWritableDatabase();
